...
一个基于 **Spring Boot 3 + Vue 3** 的前后端分离后台管理系统脚手架，包含完整的用户认证、权限控制（RBAC）、菜单管理、操作日志、数据统计与文件上传等后台管理常用功能，可作为新项目快速起步的通用骨架。

---

## 开源说明
本项目采用 **MIT 开源协议** 进行开源。
✅ 允许个人/企业免费使用、二次修改、商业用途、二次分发；
✅ 仅要求在衍生项目中保留原版权与 MIT 协议声明；
❌ 作者不承担软件使用带来的任何直接或间接风险。
...
---
>>>>>>> 4b5708f3d856c57701950be9ae68a8dcfc6215fa
