...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (196, '操作日志', 10, 0, 'com.admin.controller.OperLogController.clean()', 'DELETE', 'admin', '', '/api/monitor/operlog/clean', '127.0.0.1', '内网IP', '', '{\"code\":200,\"msg\":\"操作成功\",\"data\":null}', 0, '', '2026-07-22 14:25:36');
INSERT INTO `sys_oper_log` VALUES (197, '用户管理', 4, 1, '用户管理', 'GET', 'admin', '', '/system/user', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:25:38');
INSERT INTO `sys_oper_log` VALUES (198, '用户管理', 1, 0, 'com.admin.controller.UserController.add()', 'POST', 'admin', '', '/api/system/user', '127.0.0.1', '内网IP', 'Body: {\"id\":6,\"username\":\"awei\",\"password\":\"******\",\"nickname\":\"测试用户\",\"email\":null,\"deptId\":null,\"avatar\":null,\"phone\":\"15566778899\",\"status\":1,\"createTime\":\"2026-07-22 14:26:14\",\"updateTime\":\"2026-07-22 14:26:14\",\"roleIds\":[2]}', '{\"code\":200,\"msg\":\"操作成功\",\"data\":null}', 0, '', '2026-07-22 14:26:14');
INSERT INTO `sys_oper_log` VALUES (199, '角色管理', 4, 1, '角色管理', 'GET', 'admin', '', '/system/role', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:26:17');
INSERT INTO `sys_oper_log` VALUES (200, '用户退出', 6, 0, 'com.admin.controller.AuthController.logout()', 'POST', '匿名', '', '/api/auth/logout', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:26:41');
INSERT INTO `sys_oper_log` VALUES (201, '发送验证码', 0, 0, 'com.admin.controller.AuthController.sendCode()', 'POST', '匿名', '', '/api/auth/send-code', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:32:24');
INSERT INTO `sys_oper_log` VALUES (202, '验证码登录', 5, 0, 'com.admin.controller.AuthController.codeLogin()', 'POST', '匿名', '', '/api/auth/login/code', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:32:32');
INSERT INTO `sys_oper_log` VALUES (203, '首页', 4, 1, '首页', 'GET', 'awei', '', '/home', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:32:32');
INSERT INTO `sys_oper_log` VALUES (204, '用户管理', 4, 1, '用户管理', 'GET', 'awei', '', '/system/user', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:32:38');
INSERT INTO `sys_oper_log` VALUES (205, '用户退出', 6, 0, 'com.admin.controller.AuthController.logout()', 'POST', '匿名', '', '/api/auth/logout', '127.0.0.1', '内网IP', '', '', 0, '', '2026-07-22 14:32:43');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$OUs4uiu6icgzk0fgZRWQreA3iUCgTDxjljQPpDDDTn1b59YnAc5J6', '超级管理员', 'adminx1@63.com', NULL, 1, '2026-06-30 15:06:14', '2026-07-22 14:25:19', '/uploads/88664664b967473dba49ae6518b775fb.jpg', '17788990011');
...
INSERT INTO `sys_user` VALUES (6, 'awei', '$2a$10$BmZ9yKOS8J858A3fJWTgQeV1Rh8Uy41ZRK5FQR/Dppuhss1ktfiy6', '测试用户', NULL, NULL, 1, '2026-07-22 14:26:14', '2026-07-22 14:26:14', NULL, '15566778899');
