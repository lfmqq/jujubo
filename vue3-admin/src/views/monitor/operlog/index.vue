<template>
  <div class="page-container">
    ...
    <el-card shadow="never" style="margin-top: 16px;">
      <div class="toolbar">
        <el-button type="danger" plain @click="handleClean" v-has-perm="'monitor:operlog:clean'">清空日志</el-button>
      </div>
      <el-table :data="tableData" border stripe v-loading="loading">
        ...
        <el-table-column label="操作" width="180" align="center" fixed="right">
          <template #default="scope">
            <el-button plain type="primary" @click="openDetail(scope.row)" v-has-perm="'monitor:operlog:list'">详情</el-button>
            <el-button plain type="danger" @click="del(scope.row)" v-has-perm="'monitor:operlog:delete'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
